...
import { calculateMixDesignFinal } from "../config/calculateMixDesignFunction.js";
...
export const calculateMixDesign=   (req, res) => {
    try {
        const inputData = req.body;

        const result = calculateMixDesignFinal(inputData);
        ...
        console.error("Error calculating mix design:", error);
        res.status(500).json({
            success: false,
